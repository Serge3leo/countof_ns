...
function (tu_std_size_expected expected pos_pos neg_pos)
    ...
    foreach (b IN ITEMS ${pos_pos})
        if (NOT b MATCHES "_vla" OR HAVE_VLA_STD_SIZE_CXX)
            if (b MATCHES "_zla" AND NOT b MATCHES "_zla_n0")
                list(APPEND pos_base ${b}_cxx.build_fail)
            elseif (b MATCHES "_eval" AND NOT MSVC)
                list(APPEND pos_base ${b}_cxx.run_eval_1)
            elseif (b MATCHES "_type")
                #silent skip list(APPEND pos_base ${b}_cxx.disable)
            else ()
