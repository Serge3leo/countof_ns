...
|                                         |                                                                                                                                                                                                                                                                                                                                            | `int [10][m][n]`                          |
| VLA0                                    | Все стандарты C99...C2Y определяют как неопределённое поведение (undefined behavior, UB) любые операции с VLA, если выражение размера не является положительным.<br><br>Однако, все компиляторы более менее лояльно относятся к нулевым выражениям размера VLA. Вероятно, к этому можно относиться, как к общепринятому расширению языка C |                                           |
