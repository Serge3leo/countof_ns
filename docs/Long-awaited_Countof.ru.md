...
Тем не менее, обычно, рассмотрение этой темы начинают с рефакторинга (п. 1, т.е. вопросов преобразования кода при изменении способов обращения: массив - указатель на массив - указатель на элемент). N3369 не исключение, в нём эти подводные камни изложены начиная с п.1.
