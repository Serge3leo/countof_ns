...
TODO Примечание. Сразу после командного файла всё нормально, но у `cmake` есть
особенность, необходимо сначала собрать `ALL_BUILD` и только потом запускать
тесты сборкой `RUN_TESTS`
