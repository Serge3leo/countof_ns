...
- [Жизнь до `_Countof`](#жизнь-до-_countof)
	- [Идиома количества элементов массива](#идиома-количества-элементов-массива)
	- [Подводные камни оператора `sizeof`](#подводные-камни-оператора-sizeof)
	- [Альтернативы без `sizeof`](#альтернативы-без-sizeof)
- [Переход к `countof()`](#переход-к-countof)
- [Реализация `countof_ns()`](#реализация-countof_ns)
	- [Без поддержки С23 и расширения `__typeof__()`](#без-поддержки-с23-и-расширения-__typeof__)
	- [С23 или расширение `__typeof__()`](#с23-или-расширение-__typeof__)
- [Реализация `countof_ns()` в C++](#реализация-countof_ns-в-c)
	- [ZLA и шаблоны](#zla-и-шаблоны)
	- [VLA и `__is_same()`](#vla-и-__is_same)
	- [Статическая рефлексия C++26](#статическая-рефлексия-c26)
...
```
# Ссылки
- GitHub: [countof_ns.h](https://github.com/Serge3leo/countof_ns/blob/main/include/countof_ns/countof_ns.h);
