...
terms = [
        ...
        (r'pos_.*\.run_eval_-1',        '⚠️<sub>eval-1</sub>'),
        (r'pos_.*\.run_eval_1',         '⚠️<sub>eval+1</sub>'),
        (r'pos_.*\.run_eval_2',         '⚠️<sub>eval+2</sub>'),
        (r'pos_.*\.run_eval_3',         '⚠️<sub>eval+3</sub>'),
        (r'pos_.*\.run_eval_4',         '⚠️<sub>eval+4</sub>'),
        (r'pos_.*\.run_eval_5',         '⚠️<sub>eval+5</sub>'),
        (r'pos_.*\.run_eval_6',         '⚠️<sub>eval+6</sub>'),
        (r'pos_.*\.run_eval_7',         '⚠️<sub>eval+7</sub>'),
