...
static void have_vla0(void) {
    ...
    tac_assert(sizeof(int) == sizeof(a1[0]));

#if HAVE_VLA0_2DIM
    size_t m2 = 42;
    int a2[m2][sizeof(a1)];
    tac_assert(n0 == sizeof(a2));
    tac_assert(n0 == sizeof(a2[0]));
    tac_assert(sizeof(int) == sizeof(a2[0][0]));
    for (size_t i = 0; i < m2; i++) {
        tac_assert(n0 == sizeof(a2[i]));
        tac_assert(sizeof(int) == sizeof(a2[i][0]));
    }

    int z2[sizeof(a1)][sizeof(a2[0])];
    tac_assert(n0 == sizeof(z2));
    tac_assert(n0 == sizeof(z2[0]));
    tac_assert(sizeof(int) == sizeof(z2[0][0]));

    size_t l3 = 56;
    int a3[l3][m2][sizeof(a2[0])];
    tac_assert(n0 == sizeof(a3));
    tac_assert(n0 == sizeof(a3[0]));
    tac_assert(n0 == sizeof(a3[0][0]));
    tac_assert(sizeof(int) == sizeof(a3[0][0][0]));
    for (size_t i = 0; i < l3; i++) {
        tac_assert(n0 == sizeof(a3[i]));
        for (size_t j = 0; j < m2; j++) {
            tac_assert(n0 == sizeof(a3[i][j]));
            tac_assert(sizeof(int) == sizeof(a3[i][j][0]));
        }
    }

    int z3[l3][sizeof(a3[0])][sizeof(a3[0][0])];
    tac_assert(n0 == sizeof(z3));
    tac_assert(n0 == sizeof(z3[0]));
    tac_assert(n0 == sizeof(z3[0][0]));
    tac_assert(sizeof(int) == sizeof(z3[0][0][0]));
    for (size_t i = 0; i < l3; i++) {
        tac_assert(n0 == sizeof(z3[i]));
        tac_assert(n0 == sizeof(z3[i][0]));
        tac_assert(sizeof(int) == sizeof(z3[i][0][0]));
    }

    int zz3[sizeof(z3)][sizeof(z3[0])][sizeof(z3[0][0])];
    tac_assert(n0 == sizeof(zz3));
    tac_assert(n0 == sizeof(zz3[0]));
    tac_assert(n0 == sizeof(zz3[0][0]));
    tac_assert(sizeof(int) == sizeof(zz3[0][0][0]));
